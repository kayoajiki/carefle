<div class="card-refined p-8">
    ...
    {{-- アップロードフォーム --}}
    <div class="mb-8">
        <h2 class="heading-3 text-[#2E5C8A] mb-4">職務経歴書をアップロード</h2>
    ...
    @if($documents && $documents->count() > 0)
        <div>
            <h2 class="heading-3 text-[#2E5C8A] mb-4">アップロード済みの職務経歴書</h2>
                        ...
                        @foreach($documents as $document)
                            <tr class="border-b border-[#2E5C8A]/10 hover:bg-[#E8F4FF]/30">
                                <td class="py-3 px-4 body-text text-[#1E3A5F]">
                                    <a 
                                        href="{{ route('career-history.view', $document->id) }}" 
                                        target="_blank"
    ...
    @else
        <div class="text-center py-8">
            <p class="body-text text-[#1E3A5F]">アップロード済みの職務経歴書はありません。</p>
        </div>
    @endif
</div>