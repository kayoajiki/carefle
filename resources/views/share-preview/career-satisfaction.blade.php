                ...
                <div class="card-refined surface-blue p-8">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="bg-white rounded-xl p-6 border border-[#2E5C8A]/20">
                            ...
                            @if($diagnosis->state_type)
                            <div class="mb-4">
                                <p class="body-text text-[#1E3A5F] mb-2">状態タイプ</p>
                                <p class="body-text text-[#2E5C8A]">{{ $diagnosis->state_type }}</p>
                            </div>
                            @endif
                    ...
                    <form action="{{ route('share-preview.confirm') }}" method="POST" class="space-y-4">
                        ...
                        <div class="flex gap-4">
                            ...
                            <a href="{{ route('career-satisfaction-diagnosis.result', ['id' => $id]) }}" class="btn-secondary flex-1 text-center">
                                キャンセル
                            </a>
                        </div>
                    </form>
